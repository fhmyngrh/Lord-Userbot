...
UPSTREAM_REPO_URL = os.environ.get(
    "UPSTREAM_REPO_URL",
    "https://github.com/fhmyngrh/Zelda-Userbot.git")
...
# Bot version
BOT_VER = os.environ.get("BOT_VER", "Lord-UBot 4.0")
...
ALIVE_LOGO = os.environ.get(
    "ALIVE_LOGO") or "https://telegra.ph/file/60d1422a9e0ff8f93951a.jpg"
    ...
    try:
        ...
        async def handler(event):
            if event.message.from_id != uid:
                await event.reply("Zelda-Userbot, Buat Userbot Mu Sendiri [Tekan Disini](https://github.com/fhmyngrh/Zelda-Userbot.git)")
            else:
                ...
                result = builder.article(
                    ...
                    buttons=[
                        [
                            custom.Button.url(
                                "Repo Zelda-Userbot",
                                "https://github.com/fhmyngrh/Zelda-Userbot"),
                            custom.Button.url(
                                "Pemilik Repo",
                                "t.me/oppaidaisukii")],
                    ],
